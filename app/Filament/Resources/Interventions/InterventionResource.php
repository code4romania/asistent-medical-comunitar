...
use App\Filament\Resources\Interventions\Pages\ManageInterventions;
use Filament\Schemas\Components\Utilities\Set;
use Filament\Schemas\Components\Grid;
use App\Enums\Intervention\CaseInitiator;
use App\Enums\Intervention\Status;
use App\Filament\Resources\InterventionResource\Pages;
use App\Filament\Resources\Interventions\RelationManagers\InterventionsRelationManager;
...
class InterventionResource extends Resource
{
    ...
    {
        return [
            'index' => ManageInterventions::route('/'),
        ];
    }
            ...
            Subsection::make()
                ...
                ->schema([
                    ...
                    Hidden::make('vulnerability_label')
                        ->afterStateHydrated(function (Set $set, $state, $livewire) {
