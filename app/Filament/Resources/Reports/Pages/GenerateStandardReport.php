...
use App\Jobs\GenerateReport\Standard\Nurse\GenerateListReportJob;
use App\Jobs\GenerateReport\Standard\Nurse\GenerateStatisticReportJob;
    ...
    protected function afterCreate(): void
    {
        ...
        if (auth()->user()->isNurse()) {
            $job = match ($this->record->type) {
                Type::LIST => GenerateListReportJob::class,
                Type::STATISTIC => GenerateStatisticReportJob::class,
            };
        }
