...
class CoordinatorStatsWidget extends BaseWidget
{
    ...
    private function getAllNursesCard(): Card
    {
        $value = User::query()
            ->onlyNurses()
        ...
        return Card::make(__('dashboard.stats.nurses_total'), $value)
