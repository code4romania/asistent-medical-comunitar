...
class C18 extends ReportQuery
{
    /**
     * Sum beneficiari with reason_removed=Deces la spital ; Copil 0-1 ani (VCV_01) OR Copil 1-5 ani (VCV_02) OR Copil 5-14 ani (VCV_03).
     */
