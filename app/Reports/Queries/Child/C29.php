...
class C29 extends ReportQuery
{
    /**
     * Sum beneficiari with Neînscris la medic de familie (VSA_02); Copil 0-1 ani (VCV_01) OR Copil 1-5 ani (VCV_02) OR Copil 5-14 ani (VCV_03).
     */
