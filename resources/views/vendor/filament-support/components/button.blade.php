...
@php
    $buttonClasses = array_merge([
        ...
        'text-white focus:ring-white border-transparent' =>  ! \in_array($color, ['secondary', 'warning']),
        'bg-primary-700 hover:bg-primary-600 focus:bg-primary-600 focus:ring-offset-primary-600' => $color === 'primary',
        ...
        'bg-warning-400 hover:bg-warning-300 focus:bg-warning-500 focus:ring-offset-warning-500' => $color === 'warning',
