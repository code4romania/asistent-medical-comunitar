        ...
        <div class="flex items-center w-full px-2 sm:px-4 md:px-6 lg:px-8">
            <div
                ...
                <button type="button" x-on:click="menuOpen = !menuOpen" class="lg:hidden">
                    <x-heroicon-o-menu x-show="!menuOpen" class="w-6 h-6" />
                    <x-heroicon-o-x x-show="menuOpen" class="w-6 h-6" x-cloak />
                </button>
                ...
                <x-filament::layouts.app.topbar.navigation class="order-3 block lg:hidden" x-show="menuOpen" />
