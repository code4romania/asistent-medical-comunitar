            ...
            @forelse ($getOptions() as $optionValue => $optionLabel)
                <div
                    ...
                    <label class="flex items-center space-x-3 rtl:space-x-reverse">
                        <input
                            @if ($isBulkToggleable()) x-on:change="checkIfAllCheckboxesAreChecked()" @endif
                            ...
                            {{ $getExtraAttributeBag()->class([
                                    'text-primary-600 transition duration-75 rounded shadow-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500 disabled:opacity-50',
